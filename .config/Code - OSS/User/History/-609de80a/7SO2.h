...
typedef struct _answerlist {
    Vector2 move;

    struct _answerList *next;
} AnswerList;
...
AnswerList *solveVariant1(Board *board);
AnswerList *solveVariant2or3(Board *board);
...
void writeFile(FILE *file, Board *board, AnswerList *answer, uint score);
